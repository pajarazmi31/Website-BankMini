    ...
    <div class="bg-white rounded-[24px] shadow-card p-6 md:p-10 w-full border border-gray-50">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5 mb-5">
            <div>
                ...
                <input type="text" placeholder="Nama Pengirim" class="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-[14px] text-gray-800 focus:outline-none focus:border-[#c0860b] transition-all">
            </div>
            <div>
                <label class="block text-[13px] font-semibold text-gray-500 mb-2">Nama Penerima</label>
                <input type="text" placeholder="Nama Penerima" class="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-[14px] text-gray-800 focus:outline-none focus:border-[#c0860b] transition-all">
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5 mb-10">
            <div>
                ...
                <input type="number" placeholder="Nominal Transfer (Rp)" class="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-[14px] text-gray-800 focus:outline-none focus:border-[#c0860b] transition-all">
            </div>
            <div>
