    ...
    <div class="bg-white rounded-[24px] shadow-card p-6 md:p-10 w-full border border-gray-50">
        ...
        <div class="flex justify-between items-start mb-8">
            <div class="flex items-center gap-3">
                ...
                <h3 class="text-[20px] font-bold text-gray-800">Edit Data Penarikan</h3>
            </div>
            <div class="w-full max-w-[200px]">
                <div class="relative">
                    <select id="edit_petugas" class="w-full border border-gray-200 rounded-lg px-4 py-2 text-[13px] text-gray-500 bg-gray-50/30 focus:outline-none focus:border-[#c0860b] appearance-none transition-all">
                        ...
                        <option value="Fakih">Fakih</option>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5 mb-5">
            <div>
                ...
                <input type="text" id="edit_nama" placeholder="Nama Lengkap" class="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-[14px] text-gray-800 focus:outline-none focus:border-[#c0860b] transition-all">
            </div>
            <div>
                <label class="block text-[13px] font-semibold text-gray-500 mb-2">No. Rekening</label>
                <input type="number" id="edit_rek" placeholder="No. Rekening" class="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-[14px] text-gray-800 focus:outline-none focus:border-[#c0860b] transition-all">
            </div>
        </div>

        <div class="mb-10">
            <label class="block text-[13px] font-semibold text-gray-500 mb-2">Nominal Penarikan</label>
            <input type="number" id="edit_nominal" placeholder="Nominal Penarikan" class="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-[14px] text-gray-800 focus:outline-none focus:border-[#c0860b] transition-all">
        </div>
