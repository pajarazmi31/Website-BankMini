...
<head>
    ...
    <title>Supervisor - Verifikasi Registrasi Rekening</title>
    <!-- Tailwind CSS -->
        ...
        <div class="bg-white h-full lg:rounded-[24px] shadow-sidebar flex flex-col pt-8 pb-8 overflow-hidden relative">
            ...
            <nav class="flex-1 flex flex-col gap-1 w-full">
                ...
                <div class="flex flex-col w-full">
                    <button onclick="toggleSubmenu('kelolaDataSubmenu', 'kelolaDataArrow')" class="relative flex items-center justify-between px-6 py-3 text-[#a3a3a3] font-medium w-full hover:bg-gray-50 transition-colors group">
                        <div class="flex items-center gap-3">
                            <i class="ph ph-list text-[22px]"></i>
                            <span class="text-[14px]">Kelola Data</span>
                        </div>
                        <i id="kelolaDataArrow" class="ph-bold ph-caret-right text-[14px] transition-transform duration-300"></i>
                    </button>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-left border-collapse">
                            ...
                            <tbody class="text-[14px] text-gray-800 font-medium">
                                <!-- 
                                    BAGIAN BACKEND: DATA TABEL VERIFIKASI REGISTRASI
                                    - Data baris statis di bawah perlu diganti dengan data dari database.
                                    - Lakukan looping foreach untuk menampilkan data nasabah yang berstatus pending (menunggu verifikasi registrasi).
                                -->
                                <!-- Row 1 -->
