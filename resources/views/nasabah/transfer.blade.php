        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-4 lg:mt-0">
            ...
            <div class="bg-primary-gradient rounded-2xl p-6 lg:p-7 relative overflow-hidden shadow-lg text-white">
                ...
                <div class="relative z-10">
                    <p class="text-[10px] lg:text-xs font-semibold tracking-widest text-gray-300 uppercase mb-3">TOTAL SALDO DITERIMA</p>
            ...
            <div class="bg-cardLight rounded-2xl p-6 lg:p-7 relative overflow-hidden shadow-sm border border-white">
                ...
                <div class="relative z-10">
                    <p class="text-[10px] lg:text-xs font-semibold tracking-widest text-textGray uppercase mb-3">TOTAL SALDO TERKIRIM</p>
        ...
        <div class="mt-10 flex flex-col lg:flex-row gap-10">
            ...
            <div class="lg:w-7/12 bg-white rounded-3xl p-6 lg:p-8 shadow-[0_4px_24px_rgba(0,0,0,0.02)] border border-gray-50 h-fit">
                ...
                <form action="#" method="POST" class="space-y-6">
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-textGray mb-2">Nama Penerima</label>
                        <!-- 
                    ...
                    <button type="submit" class="w-full bg-[#10a163] hover:bg-green-700 text-white font-bold text-sm py-4 rounded-xl transition-colors mt-2 shadow-sm">Kirim</button>
                </form>
            </div>
            ...
            <div class="lg:w-5/12">
                <div class="flex justify-between items-center mb-8 px-2">
                    <h3 class="text-[16px] font-bold text-gray-800">Riwayat Terbaru</h3>
                ...
                <div class="space-y-6 px-2">
                    ...
                    <div class="flex justify-between items-center">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <p class="font-bold text-[14px] text-gray-800">{{ $item['name'] }}</p>
                                <p class="text-[10px] text-gray-500 mt-0.5">{{ $item['date'] }}</p>
                            </div>
                        </div>
                        <p class="font-bold text-[13px] text-[{{ $item['color'] }}]">{{ $item['amount'] }}</p>
                    </div>
                    @endforeach
                </div>
            </div>
            ...
            <div class="space-y-8">
                ...
                <div class="flex justify-between items-center">
                    <div class="flex items-center gap-4">
                        <i class="ph-fill ph-user-circle text-[44px] text-[#1c3a5a]"></i>
                        <div>
                            <p class="font-bold text-[15px] lg:text-[16px] text-gray-800">{{ $item['name'] }}</p>
                            <p class="text-[11px] lg:text-[12px] text-gray-500 mt-0.5">{{ $item['date'] }}</p>
                        </div>
                    </div>
                    <p class="font-bold text-[14px] lg:text-[15px] text-[{{ $item['color'] }}]">{{ $item['amount'] }}</p>
                </div>
                @endforeach
            </div>
        </div>
